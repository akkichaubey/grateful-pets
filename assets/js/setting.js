jQuery(document).ready(function () {
  ...
  if (wWidth <= 1240) {
    jQuery(".header-menu ul li.dropdown").click(function () {
      ...
      jQuery(".header-menu ul li.dropdown")
        .not(this)
        .find(".sub-menu")
        .slideUp();
    });
